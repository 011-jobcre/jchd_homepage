...
class PageAdmin(SortableAdminMixin, TranslatableAdmin):
    list_display = ("title", "page_type", "slug", "order", "is_published")
...
class NewsAdmin(SortableAdminMixin, admin.ModelAdmin):
    list_display = ("title", "slug", "order", "date", "is_published")
...
class MenuItemAdmin(SortableAdminMixin, TranslatableAdmin):
    list_display = ("name", "url_prefix", "key", "is_active", "site_config", "order")
    fields = ("name", "url_prefix", "key", "is_active", "image", "site_config")
