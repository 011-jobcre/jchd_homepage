...
ROOT_URLCONF = "jchd_homepage.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "core.context_processors.about_pages",
...
WSGI_APPLICATION = "jchd_homepage.wsgi.application"
...
PARLER_LANGUAGES = {
    ...
    "default": {
        "fallbacks": ["ja"],  # if translation not found, use ja
